 ...
 * STU FEI
 * 
 * Copyright (C) 2017-2017 by STU FEI and the contributors
 * 
 ...
 */
package sk.fei.rapidminer.extension;
 ...
 * @author REPLACEME
 */
public final class PluginInitKalmanFilter {

		private PluginInitKalmanFilter() {
